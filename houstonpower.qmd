...
feb7_plot <- tm_shape(feb7_cropped) +
  ...
  tm_title(text = "Houston, TX: February 7, 2021") +
...
feb16_plot <- tm_shape(feb16_cropped) +
  tm_raster(breaks = c(0, 100, 200, 300, 400, 500, Inf),
            palette = night_light_colors,
            title = "Night Light Intensity (nW cm-2sr-1)") +
  tm_title(text = "Houston, TX: February 16, 2021") +
  tm_graticules(alpha = 0.5)

tmap_save(feb16_plot, "feb16_plot.png")

both_plots <- tmap_arrange(feb7_plot, feb16_plot, nrow = 1)
tmap_save(both_plots, "figs/both_lights_plots.png")

```


**Difference in Light Intensity** 
![Night light intensity on both days](figs/both_lights_plots.png){fig-align="center"}
...
tmap_save(houses_plot, "figs/houses_plot.png")
```
...
tmap_save(census_blackout_plot, "figs/census_blackout_plot.png")
```
