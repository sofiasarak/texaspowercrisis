...
::: {#fig-light-intensity-both-days}
**Difference in Light Intensity** ![Night light intensity on both days](both_plots.png)
:::
...
The number of homes that lost power in Houston between February 7th and 16th, 2021 is `houses_estimate`.
